          ...
          <article class="col-main">
            ...
            <div class="category-products">
              <ol class="products-list" id="products-list">
                <li class="item first">
                  <div class="product-image"> <a href="product_detail.jsp" title="HTC Rhyme Sense"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product1.jpg" alt="HTC Rhyme Sense"> </a>
                  
                  </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="HTC Rhyme Sense">Covmed Mystone 60S Tablets</a></h2>
                    <div class="ratings">
                    ...
                    <div class="desc std">
                      ...
                      <p>Sed sed interdum diam. Donec sit ametenim tempor, dapibus nunc eu, 
                        tincidunt mi. Vivamus dictum nec... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                    <div class="price-box">
                ...
                <li class="item even">
                  <div class="product-image"> <a href="product_detail.jsp" title="Microsoft Natural Keyboard"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product2.jpg" alt="Microsoft Natural Keyboard"> </a>
                    <div class="new-label new-top-left">New</div>
                  </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="Microsoft Natural Keyboard">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">
                      <p>Sed volutpat ac massa eget 
                        ...
                        Aenean volutpat lacus at dolor blandit. </p>
                      <p>Sed sed interdum diam. Donec sit ametenim tempor, dapibus nunc eu, 
                        tincidunt mi. Vivamus dignissimm ... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a></p>
                    </div>
                ...
                <li class="item odd">
                  <div class="product-image"> <a href="product_detail.jsp" title="30&quot; Flat-Panel HD Monitor"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product3.jpg" alt="30&quot; Flat-Panel HD Monitor"> </a>
                    <div class="sale-label sale-top-left">- 40% sale</div>
                  </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="30&quot; Flat-Panel HD Monitor">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">Computer games, digital photo 
                      ...
                      <p>Sed sed interdum diam. Donec sit ametenim tempor, dapibus nunc eu, 
                        tincidunt mi. </p>
                      <p>Phasellus consequat id purus in convallis. Nulla quis... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a></p>
                    </div>
                ...
                <li class="item even">
                  <div class="product-image"> <a href="product_detail.jsp" title="19&quot; Widescreen LCD Monitor"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product4.jpg" alt="19&quot; Widescreen LCD Monitor"> </a>
                 
                  </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="19&quot; Widescreen LCD Monitor">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">2 ms response time; 10,000:1 contrast ratio; 300 cd/m² brightness; 1440 x 900 maximum resolution; DVI-D and 15-pin D-sub inputs
                      <p>Phasellus consequat id purus 
                        pretium enimnec, tristique... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                ...
                <li class="item odd">
                  <div class="product-image"> <a href="product_detail.jsp" title="Seagate 250GB HD "> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product5.jpg" alt="Seagate 250GB HD "> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="Seagate 250GB HD ">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">1 TB - 7200RPM, SATA 3.0Gb/s, 32MB Cache
                      ...
                      <p>Sed sed interdum diam. Donec sit ametenim tempor, dapibus nunc eu, 
                        ...
                        Integerarcu libero, dictum nec congue sed, faucibus ... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                ...
                <li class="item even">
                  <div class="product-image"> <a href="product_detail.jsp" title="Seagate 500GB HD"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product6.jpg" alt="Seagate 500GB HD"> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="Seagate 500GB HD">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">1 TB - 7200RPM, SATA 3.0Gb/s, 32MB Cache
                      ...
                      <p> Donec eget feugiat ante. 
                        Integerarcu libero... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                ...
                <li class="item odd">
                  <div class="product-image"> <a href="product_detail.jsp" title="Intel Core 2 Extreme QX9775"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product7.jpg" alt="Intel Core 2 Extreme QX9775"> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="Intel Core 2 Extreme QX9775">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">Intel Core 2 Extreme QX9775 
                      ...
                      <p>Phasellus consequat... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                ...
                <li class="item even">
                  <div class="product-image"> <a href="product_detail.jsp" title="24&quot; Widescreen LCD Monitor"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product8.jpg" alt="24&quot; Widescreen LCD Monitor"> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="24&quot; Widescreen LCD Monitor">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">5 ms response time; 10,000:1 contrast ratio; 400 cd/m² brightness; 1920 x 1200 maximum resolution; DVI-D and 15-pin D-sub inputs
                      ...
                      <p>Phasellus consequat id purus in convallis. Nulla quis nunc auctor, 
                        pretium enimnec, tristique magna... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                    <div class="price-box"> <span class="regular-price"> <span class="price">$699.99</span> </span> </div>
                    <div class="actions">
                      <button class="button btn-cart ajx-cart" title="Add to Cart" type="button"><span>Add to Cart</span></button>
                ...
                <li class="item odd">
                  <div class="product-image"> <a href="product_detail.jsp" title="Logitech Optical Trackman"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product9.jpg" alt="Logitech Optical Trackman"> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="Logitech Optical Trackman">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                    ...
                    <div class="desc std">Our most advanced trackball yet. 
                      ...
                      <p>Vivamus vitae arcu faucibus, dictum 
                        magna vel, adipiscing... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
                ...
                <li class="item last even">
                  <div class="product-image"> <a href="product_detail.jsp" title="Logitech diNovo Edge Keyboard"> <img class="small-image" src="${pageContext.request.contextPath}/statics/products-images/product10.jpg" alt="Logitech diNovo Edge Keyboard"> </a> </div>
                  <div class="product-shop">
                    <h2 class="product-name"><a href="product_detail.jsp" title="Logitech diNovo Edge Keyboard">Covmed Mystone 60S Tablets for covid-19</a></h2>
                    <div class="ratings">
                      <div class="rating-box">
                        <div style="width:80%" class="rating"></div>
                      </div>
                    ...
                    <div class="desc std">Li-Ion powered.
                      ...
                      <p>Integerarcu libero, dictum nec congue sed, faucibus sit... <a class="link-learn" title="" href="product_detail.jsp">Learn More</a> </p>
                    </div>
