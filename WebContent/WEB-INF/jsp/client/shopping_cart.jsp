...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/font-awesome.min.css" media="all">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/simple-line-icons.css" media="all">
                ...
                <form method="post" action="#updatePost/">
                  ...
                  <fieldset>
                    <table class="data-table cart-table" id="shopping-cart-table">
                      ...
                      <tbody>
                        <tr class="first odd">
                          <td class="image"><a class="product-image" title="Sample Product" href="#/women-s-crepe-printed-black/"><img width="75" alt="Sample Product" src="${pageContext.request.contextPath}/products-images/product1.jpg"></a></td>
                        ...
                        <tr class="last even">
                          <td class="image"><a class="product-image" title="Sample Product" href="#women-s-u-tank-top/"><img width="75" alt="Sample Product" src="${pageContext.request.contextPath}/products-images/product4.jpg"></a></td>
                  ...
                  <ul class="products-grid">
                    <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/products-images/product3.jpg"> </a>
                    ...
                    <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/products-images/product4.jpg"> </a>
                    ...
                    <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/products-images/product5.jpg"> </a>
                    ...
                    <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/products-images/product6.jpg"> </a>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/revslider.js"></script> 
