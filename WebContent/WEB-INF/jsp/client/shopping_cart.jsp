                    ...
                    <table class="data-table cart-table" id="shopping-cart-table">
                      ...
                      <tbody class="qingk">
                      	<c:forEach items="${cartlist}" var="cartlist">
                      		<tr class="first odd">
	                          <td class="image"><a class="product-image" title="Sample Product" href="${pageContext.request.contextPath}/product_detail/${cartlist.goodsId}"><img width="75" alt="Sample Product" src="${pageContext.request.contextPath}/statics/file/${cartlist.gPhoto}"></a></td>
	                          <td><h2 class="product-name"> <a href="#/women-s-crepe-printed-black/">${cartlist.goodsName}</a> </h2></td>
	                          <td class="a-center"><a title="Edit item parameters" class="edit-bnt" href="#configure/id/15945/"></a></td>
	                          <td class="a-right"><span class="cart-price"> <span class="price">￥${cartlist.goodsPrice}</span> </span></td>
	                          <td id="qkNumber" class="a-center movewishlist">
	                          	<input class="Number" style="text-align: center;" useralice="${cartlist.userAlice}" cId="${cartlist.cid}"  goodsname="${cartlist.goodsName}" size="4" value="${cartlist.goodsNumber}">
	                          </td>
	                          <td class="a-right movewishlist"><span class="cart-price"> <span class="price" id="newprice">￥${cartlist.goodsNumber*cartlist.goodsPrice}</span> </span></td>
	                          <td class="a-center last"><a id="delete" href="${pageContext.request.contextPath}/delCartByCid/${cartlist.cid}" class="button remove-item" title="删除" ><span><span>删除</span></span></a></td>
	                        </tr>	
	                        <c:set var="sum" value="${sum+cartlist.goodsNumber*cartlist.goodsPrice}"></c:set>
							<c:set var="orderName" value="${orderName}${cartlist.goodsName}*${cartlist.goodsNumber}"></c:set>
                        </c:forEach>
                      </tbody>
                    </table>
                  </fieldset>
                    ...
                    <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="a-right" style=""><span class="price" id="sum">￥${sum }</span></td>
                        </tr>
                      </tbody>
                    </table>
                    <ul class="checkout">
                      ...
                      <br>
                      <li><a title="Checkout with Multiple Addresses" href="multiple_addresses.html">结帐多个地址</a> </li>
                      <br>
                    </ul>
                  </div>
                  <!--inner--> 
                  ...
                  <c:forEach items="${remaiList }" var="remai">
                    <li class="item col-lg-3 col-md-3 col-sm-4 col-xs-6">
                      <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/file/${remai.goodsPhoto}"> </a>
                            <div class="box-hover">
                          ...
                          <div class="item-info">
                            <div class="info-inner">
                              <div class="item-title"> <a title="Retis lapen casen" href="product_detail.html"> ${remai.goodsName} </a> </div>
                              <div class="rating">
                                <div class="ratings">
                              ...
                              <div class="item-content">
                                <div class="item-price">
                                  <div class="price-box"> <span class="regular-price"> <span class="price">${remai.goodsPrice}</span> </span> </div>
                                </div>
                               <div class="action">
...
$(function(){
			   ...
			   success:function(msg){
                      	...
                      	for(var i in msg){
                      		var str='<tr class="first odd">'
		                        ...
		                        +'<td><h2 class="product-name"> <a href="#/women-s-crepe-printed-black/">'+msg[i].goodsName+'</a> </h2></td>'
		                        +'<td class="a-center"><a title="Edit item parameters" class="edit-bnt" href="#configure/id/15945/"></a></td>'
		                        +'<td class="a-right"><span class="cart-price"> <span class="price">￥'+msg[i].goodsPrice+'</span> </span></td>'
		                        +'<td id="qkNumber" class="a-center movewishlist">'
		                        ...
		                        +'</td>'
		                        +'<td class="a-right movewishlist"><span class="cart-price"> <span class="price" id="newprice">￥'+msg[i].goodsNumber*msg[i].goodsPrice+'</span> </span></td>'
                      	...
                      	$("#js").empty().append('<a href="${pageContext.request.contextPath}/addNewOrder?orderName='+orderName+'&total='+price+'">'
                            	+'<button class="button btn-proceed-checkout" title="Proceed to Checkout" type="button"><span>进行结算</span></button>'
                              	+'</a>');
			   },
	...
	$(function(){
		...
		$("#js").click(function(){
			...
			if(r==true){
			location.href="${pageContext.request.contextPath}/addNewOrder?orderName=${orderName}&total=${sum}&userAlice=${loginer.userAlice}";
			alert("购买成功");
			}else{return false;}
		})
	})
