          ...
          <div class="col-md-3 col-sm-6">
            <div class="footer-column pull-left">
              ...
              <ul class="links">
                ...
                <li><a href="${pageContext.request.contextPath}/contact_us" title="Contact Us">Contact Us</a></li>
    ...
    <div class="footer-top">
      <div class="container">
        <div class="row">
      	...
      	&copy; 2020 ThemesGround. All Rights Reserved.
      	</div>
          <div class="col-xs-12 col-sm-4">
            <div class="payment-accept"> <img src="${pageContext.request.contextPath}/statics/images/payment-1.png" alt=""> <img src="${pageContext.request.contextPath}/statics/images/payment-2.png" alt=""> <img src="${pageContext.request.contextPath}/statics/images/payment-3.png" alt=""> <img src="${pageContext.request.contextPath}/statics/images/payment-4.png" alt=""> </div>
          </div>
        </div>
      </div>
    </div>
