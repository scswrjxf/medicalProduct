<%@ page language="java" pageEncoding="UTF-8"%><!-- container-fluid 开始 -->
					...
					<div id='rev_slider_4' class='rev_slider fullwidthabanner'>
						<ul>
							<li data-transition='random' data-slotamount='7'
								...
								data-thumb='${pageContext.request.contextPath}/statics/images/slide-img1.jpg'><img
								src='${pageContext.request.contextPath}/statics/images/slide-img1.jpg'
											...
											<div class="col-lg-9 col-sm-9 col-md-9">
												<div class="info">
													...
													<div class='tp-caption LargeTitle sfl  tp-resizeme '
														...
														<span style="font-weight: normal; display: block">新冠病毒</span> 预防
													</div>
													<div class='tp-caption Title sft  tp-resizeme '
														...
														data-splitout='none' data-elementdelay='0.1'
														data-endelementdelay='0.1'
														style='z-index: 4; white-space: nowrap;'>所有药品均可享受20％的折扣。</div>
							...
							<li data-transition='random' data-slotamount='7'
								data-masterspeed='1000' data-thumb='images/slide-img2.jpg'><img
								src='${pageContext.request.contextPath}/statics/images/slide-img2.jpg'
								data-bgfit='cover' data-bgrepeat='no-repeat' alt="banner" />
								<div class="container">
									<div class="content_slideshow">
										<div class="row">
											...
											<div class="col-lg-9 col-sm-9 col-md-9">
												<div class="info">
													...
													<div class='tp-caption LargeTitle sfl  tp-resizeme '
														...
														data-endelementdelay='0.1'
														style='z-index: 3; white-space: nowrap;'>
														<span style="font-weight: normal; display: block">Covid-19
															Virus</span> vaccination
													</div>
													<div class='tp-caption Title sft  tp-resizeme '
														data-endspeed='500' data-speed='500' data-start='1450'
														data-easing='Power2.easeInOut' data-splitin='none'
