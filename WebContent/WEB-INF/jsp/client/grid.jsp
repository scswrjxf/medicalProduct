              ...
              <ul class="products-grid">
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product1.jpg"> </a>
                          ...
                          <div class="item-info">
                            <div class="info-inner">
                              <div class="item-title"> <a title="Retis lapen casen" href="product_detail.jsp">Covmed Mystone 60S Tablets for covid-19</a> </div>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product2.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product3.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product4.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product5.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product6.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product7.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product8.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product9.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product10.jpg"> </a>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product11.jpg"> </a>
                              <div class="box-hover">
                                <ul class="add-to-links">
                                  <li><a class="link-quickview" href="quick_view.jsp"></a> </li>
                                  <li><a class="link-wishlist" href="wishlist.jsp"></a> </li>
                ...
                <li class="item col-lg-4 col-md-4 col-sm-4 col-xs-6">
                  <div class="item-inner">
                          <div class="item-img">
                            <div class="item-img-info"> <a class="product-image" title="Retis lapen casen" href="product_detail.jsp"> <img alt="Retis lapen casen" src="${pageContext.request.contextPath}/statics/products-images/product12.jpg"> </a>
