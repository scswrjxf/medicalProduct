					...
					<div class="col-sm-12 col-xs-12">
						<div class="block block-company"
							...
							<ol id="recently-viewed-items">
								<li class="item odd"><a href="#">用户设置</a></li>
												...
												<tfoot>
													<tr class="first last">
														<td class="a-right last" colspan="50"><a id="jxgw"
															...
															<button useralice="${loginer.userAlice }"
												...
												<tbody class="qingk">
													<c:forEach items="${cartlist}" var="cartlist">
														<tr class="first odd">
															...
															<td id="qkNumber" class="a-center movewishlist"><input
																class="Number" style="text-align: center;"
																useralice="${cartlist.userAlice}" cId="${cartlist.cid}"
																goodsname="${cartlist.goodsName}" size="4"
																value="${cartlist.goodsNumber}"></td>
								...
								<div class="cart-collaterals row">
									<div class="totals col-sm-4" style="float: right;">
										...
										<div class="inner">
											...
											<ul class="checkout">
												<div id="jspj">
												<li id="js" Sum="${ sum}" ordername="${orderName }" useralice="${loginer.userAlice }">
													<!-- <a > -->
