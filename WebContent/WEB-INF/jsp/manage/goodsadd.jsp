...
<div class="right">
        ...
        <div class="providerAdd">
           ...
           action="${pageContext.request.contextPath}/server/goodsnewadd" enctype="multipart/form-data">
                ...
                <div>
                   ...
                   <input type="text" name="goodsPrice" id="goodsPrice" value=""> 
					<font color="red"></font>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" type="text" name="goodsNumber" id="goodsNumber" value=""> 
					<font color="red"></font>
                </div>
                 <div>
                    <label >商品分类：</label>
					...
					<select name="categoryId.categoryId" id="categoryId">
						<c:forEach items="${category }" var="categoryList">
							<c:choose>
								...
								<c:otherwise><option value="${categoryList.categoryId}">${categoryList.category}</option></c:otherwise>
							</c:choose>
						</c:forEach>
					</select>
	        		<font color="red"></font>
                 ...
                 <div>
                    <label for="goodsPhoto">商品图片：</label>
                   	<input type="file" name="a_goodsPhoto" id="goodsPhoto"/>
                    <font color="red"></font>
                </div>
