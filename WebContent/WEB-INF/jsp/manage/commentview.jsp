...
<%@include file="/WEB-INF/jsp/manage/common/head.jsp"%>
 <div class="right">
        <div class="location" style="margin-bottom: 20px;margin-top: 10px;">
            ...
            <span style="color: black;">评论管理页面 >> 评论信息查看页面</span>
        </div>
        <div class="providerView">
            ...
            <p><strong>评论用户头像：</strong><span><img alt="" style="width: 100px;height: 100px;" 
            src="${pageContext.request.contextPath}/statics/file/${commentInfor.uId.userPhoto }"></span></p>
